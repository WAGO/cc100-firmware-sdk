...
#-----------------------------------------------------------------------------#
#-----------------------------------------------------------------------------#
# Script:   vtp-ctp_switch_boot_partition.sh
#
# Brief:    Used to switch the active system.
#
# Usage:
#    vtp-ctp_switch_boot_partition.sh         - switch to another system
#    vtp-ctp_switch_boot_partition.sh {1|2}   - switch to system[1|2]
#
