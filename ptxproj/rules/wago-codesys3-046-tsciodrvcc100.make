...
CDS3_TSCIODRVCC100_VERSION   := 1.0.10
...
CDS3_TSCIODRVCC100_PACKAGE_DIR := $(PTXDIST_TEMPDIR)/package/$(CDS3_TSCIODRVCC100_PACKAGE_NAME)
...
$(STATEDIR)/cds3-tsciodrvcc100.prepare:
	@$(call targetinfo)
ifndef PTXCONF_WAGO_TOOLS_BUILD_VERSION_BINARIES
	$(MAKE) -C $(CDS3_TSCIODRVCC100_DIR) SYSROOT=$(PTXCONF_SYSROOT_TARGET) itf
	$(MAKE) -C $(CDS3_TSCIODRVCC100_DIR) SYSROOT=$(PTXCONF_SYSROOT_TARGET) dep
endif
	@$(call touch)
...
ifndef PTXCONF_WAGO_TOOLS_BUILD_VERSION_BINARIES
	...
	@cp $(CDS3_TSCIODRVCC100_DIR)/*Itf.h $(PTXCONF_SYSROOT_TARGET)/usr/include/codesys3/
...
ifdef PTXCONF_WAGO_TOOLS_BUILD_VERSION_BINARIES
	...
	mkdir -p $(CDS3_TSCIODRVCC100_PACKAGE_DIR)
	cd $(CDS3_TSCIODRVCC100_PACKAGE_DIR) && \
	ar -xov $(CDS3_TSCIODRVCC100_PLATFORMCONFIGPACKAGEDIR)/$(CDS3_TSCIODRVCC100_PACKAGE_NAME).ipk
	@$(call install_archive, cds3-tsciodrvcc100, 0, 0, $(CDS3_TSCIODRVCC100_PACKAGE_DIR)/data.tar.gz, )
else
	# WAGO_TOOLS_BUILD_VERSION_TRUNK | WAGO_TOOLS_BUILD_VERSION_RELEASE
