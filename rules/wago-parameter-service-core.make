...
WAGO_PARAMETER_SERVICE_CORE_VERSION        := 1.2.12-162504821666
...
WAGO_PARAMETER_SERVICE_CORE                := wago-parameter-service-core-$(WAGO_PARAMETER_SERVICE_CORE_VERSION)
WAGO_PARAMETER_SERVICE_CORE_DIR            := $(BUILDDIR)/$(WAGO_PARAMETER_SERVICE_CORE)
WAGO_PARAMETER_SERVICE_CORE_GIT_URL        := http://svtfs01007:8080/tfs/ProductDevelopment/Systemdienste/_git/ParameterService
...
ifndef PTXCONF_WAGO_PARAMETER_SERVICE_CORE_DEV
	...
	@$(call extract, WAGO_PARAMETER_SERVICE_CORE)
	@$(call patchin, WAGO_PARAMETER_SERVICE_CORE)
...
WAGO_PARAMETER_SERVICE_CORE_CONF_OPT   := $(CROSS_CMAKE_USR) -D CMAKE_BUILD_TYPE=$(WAGO_PARAMETER_SERVICE_CORE_BUILDCONFIG) -D PFC-DEMO:BOOL=OFF -D NLOHMANN:BOOL=OFF -D WSTD:BOOL=OFF
